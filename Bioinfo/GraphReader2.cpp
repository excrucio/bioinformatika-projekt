...
bool GraphReader2::calculateEdge
( int orientationA,
  int AStart,
  int AEnd,
  int ALenghth,
...
void GraphReader2::checkOrientation(int orientationA, int orientationB, MapEdge *edge)
{
...
void GraphReader2::read(string overlapsPath)
{
...
void GraphReader2::removeContainedEdges()
{
...
void GraphReader2::removeZeroes()
{
   DataBase2 *b = DataBase2::getInstance();
   vector <int> erase;
...
void GraphReader2::testGraphReader()
{
    ...
    DataBase2* data = DataBase2::getInstance(); //access to DataBase2
    ...
    data->putEdge(edge12); //putting edge info to DataBase2
    ...
    data->addContained(5,4); //adding contained edges to DataBase2 structure
